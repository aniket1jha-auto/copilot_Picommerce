...
export const AI_VARIANTS: Partial<Record<ChannelType, AnyChannelContent[]>> = {
  sms: [
    { body: 'Verify your Emirates ID in 2 mins & unlock full account features. Tap: https://p.me/verify' } satisfies SMSContent,
    { body: '⏰ Last 24 hours to verify your Emirates ID — avoid account limits. Verify now: https://p.me/verify' } satisfies SMSContent,
    { body: 'تحقّق من هويتك الإماراتية الآن لتفعيل حسابك بالكامل. اضغط هنا: https://p.me/verify' } satisfies SMSContent,
  ],
  whatsapp: [
    {
  ...
  in_app_banner: [
    ...
    } satisfies InAppBannerContent,
    {
      ...
      body: "Your pre-approved AED 50,000 loan offer expires tonight. Zero processing fee — claim before it's gone.",
